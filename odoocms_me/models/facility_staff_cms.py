...
class OdooCMSFaculty(models.Model):
    ...
    _description = 'CMS Staff'
    _inherit = ['mail.thread', 'mail.activity.mixin']

    code1 = fields.Char(string="Code1")
    name = fields.Char(string="Code1")
    ...
    work_location = fields.Char('University Mailing Address', related='employee_id.work_location', readonly=True,
                                store=True)
    emergency_contact = fields.Char('Emergency Contact', related='employee_id.emergency_contact', readonly=True,
                                    store=True)
    ...
    last_login = fields.Datetime('Latest Connection',related = 'partner_id.user_id.login_date', readonly=1, )
    # related = 'partner_id.user_id.login_date'

    image_1920 = fields.Char('image 1920')
    image_128 = fields.Char('image 1920')
    ...
    zip = fields.Char('zip')
    country_id = fields.Char('country_id')
...
class OdooCMSAward(models.Model):
    ...
    # class OdooCMSFacultyStaffs(models.Model):
    #     _name = 'odoocms.faculty.staff'
