...
class OdooCMSAcademicSession(models.Model):
    ...
    term_ids = fields.One2many('odoocms.academic.term','session_id','Academic Terms')
...
class OdooCMSAcademicTermLine(models.Model):
    ...
    term_id = fields.Many2one('odoocms.academic.term', string='Name', required=True, help='Name of Term')
...
class OdooCMSAcademicTermPlanning(models.Model):
    ...
    type = fields.Selection([
        ...
        ('duesdate', 'Dues Date'),
        ('withdraw', 'Course Withdraw'),
        ('i-grade', 'I Grade'),
        ('cancellation', 'Cancellation'),
        ('drop', 'Drop'),
        ('en-delete', 'Delete Enrollment'),
